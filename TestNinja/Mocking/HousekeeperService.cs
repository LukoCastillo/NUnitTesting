...
namespace TestNinja.Mocking
{
    public class HousekeeperService
    {
        ...
        private readonly IStatementGeneretor _statementGeneretor;
        private readonly IEmailSender _emailSender;
        private readonly IXtraMessageBox _xtraMessageBox;
        public HousekeeperService(
            IUnitOfWork unitOfWork, 
            IStatementGeneretor statementGeneretor,
            IEmailSender emailSender,
            IXtraMessageBox xtraMessageBox)
        {
            _unitOfWork = unitOfWork;
            _statementGeneretor = statementGeneretor;
        ...
        public void SendStatementEmails(DateTime statementDate)
        {
            ...
            foreach (var housekeeper in housekeepers)
            {
                ...
                var statementFilename = _statementGeneretor.SaveStatement(housekeeper.Oid, housekeeper.FullName, statementDate);
